...
class TraceService:
    ...
    @staticmethod
    async def create_trace(agent_id: str, user_id: str, trace_data: Dict[str, Any], db: Session) -> TraceModel:
        """
        Create a new trace.
        ...
        try:
            ...
            if "metadata" in trace_data_with_defaults:
                trace_data_with_defaults["trace_metadata"] = trace_data_with_defaults.pop("metadata")
    ...
    @staticmethod
    async def get_traces_by_agent(agent_id: str, user_id: str, db: Session) -> List[TraceModel]:
        """
    ...
    @staticmethod
    async def update_trace(trace_id: str, user_id: str, trace_data: Dict[str, Any], db: Session) -> TraceModel:
        """
        Update a trace.
    ...
    @staticmethod
    async def add_observation(trace_id: str, user_id: str, observation_data: Dict[str, Any], db: Session) -> ObservationModel:
        """
        ...
        try:
            ...
            if "metadata" in observation_data:
                observation_data["observation_metadata"] = observation_data.pop("metadata")
    ...
    @staticmethod
    async def get_trace_with_observations(trace_id: str, user_id: str, db: Session) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            for trace_data in traces:
                try:
                    ...
                    print(f"Error creating trace model from data: {trace_data}, error: {str(model_error)}")
